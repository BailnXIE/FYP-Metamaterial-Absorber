...
if __name__ == "__main__":
    ...
    wavelengths, n_complex = load_material_data("Material_MgF2.csv")
    ...
    eps_inf = 1.37  # For metals, this is typically 1.0
    ...
    fig.savefig("eps_fit_MgF2.png", dpi=150, bbox_inches="tight")
    print("Plot saved as 'eps_fit_MgF2.png'")
