...
if __name__ == "__main__":
    ...
    wavelengths, n_complex = load_material_data("Material_GaN.csv")
    ...
    eps_inf = 2.3392  # For metals, this is typically 1.0
    ...
    fig.savefig("eps_fit_GaN.png", dpi=150, bbox_inches="tight")
    print("Plot saved as 'eps_fit_GaN.png'")
