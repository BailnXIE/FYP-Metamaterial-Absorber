...
if __name__ == "__main__":
    ...
    wavelengths, n_complex = load_material_data("Material_Al2O3.csv")
    ...
    eps_inf = 1.7449  # For metals, this is typically 1.0
    ...
    num_lorentzians = 5  # Increased for better fit of metal data
    ...
    fig.savefig("eps_fit_Al2O3.png", dpi=150, bbox_inches="tight")
    print("Plot saved as 'eps_fit_Al2O3.png'")
