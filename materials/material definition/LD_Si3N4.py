...
if __name__ == "__main__":
    ...
    wavelengths, n_complex = load_material_data("Material_Si3N4.csv")
    ...
    eps_inf = 1.9966  # For metals, this is typically 1.0
    ...
    wl_max = 4.5  # maximum wavelength (units of μm)
    ...
    num_lorentzians = 3  # Increased for better fit of metal data
    ...
    fig.savefig("eps_fit_Si3N4.png", dpi=150, bbox_inches="tight")
    print("Plot saved as 'eps_fit_Si3N4.png'")
