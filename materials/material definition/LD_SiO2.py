...
if __name__ == "__main__":
    ...
    wavelengths, n_complex = load_material_data("Material_SiO2.csv")
    ...
    eps_inf = 1.4734  # For metals, this is typically 1.0
    ...
    fig.savefig("eps_fit_SiO2.png", dpi=150, bbox_inches="tight")
    print("Plot saved as 'eps_fit_SiO2.png'")
