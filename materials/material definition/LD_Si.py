...
if __name__ == "__main__":
    ...
    eps_inf = 1.2  # For metals, this is typically 1.0
    ...
    wl_max = 4.50  # maximum wavelength (units of μm)
    ...
    num_lorentzians = 12  # Increased for better fit of metal data

    # Number of times to repeat local optimization with random initial values.
    num_repeat = 20  # Increased for better optimization
